...
The verified midas_small_256_fp16.tflite file is bundled under android/app/src/main/assets/ and is required for the Android build. The app never downloads the model at runtime or build time.
